...
export const translations = {
  vi: {
    ...
    dashboard: {
      ...
      alerts: {
        needAttention: "{count} mục cần lưu ý",
        allDone: "Không có gì cần xử lý",
        tabCutoffs: "Cut-off",
        tabContainers: "Cont cần xử lý",
        tabVessels: "Tàu cập bến",
        ...
        voyage: "Chuyến",
        closing: "Closing",
        timeLeftHours: "còn {n} giờ",
        timeLeftDays: "còn {n} ngày",
        timeLeftSoon: "sắp tới",
      ...
      distributions: {
        ...
        countCarriers: "{n} hãng",
        countSites: "{n} cảng",
        countTypes: "{n} loại",
        countEvents: "{n} sự kiện",
    ...
    common: {
      ...
      aiModelUnavailableHint: "Key hợp lệ nhưng model này không dùng được. Bấm nút tải lại danh sách model rồi chọn một model khác trong danh sách.",
    ...
    bulk: {
      ...
      resyncSameEventTooltip: "Chỉ cập nhật sự kiện cùng loại với các dòng đã chọn",
      resyncAllEvents: "Tra lại (mọi sự kiện)",
      resyncAllEventsTooltip: "Lưu tất cả sự kiện ePort trả về cho các container đã chọn",
  ...
  en: {
    ...
    dashboard: {
      ...
      alerts: {
        ...
        allDone: "Nothing to handle",
        tabCutoffs: "Cut-off",
        tabContainers: "Containers to handle",
        tabVessels: "Vessel berthing",
        ...
        voyage: "Voyage",
        closing: "Closing",
        timeLeftHours: "{n}h left",
        timeLeftDays: "{n}d left",
        timeLeftSoon: "now",
      ...
      distributions: {
        ...
        countCarriers: "{n} carriers",
        countSites: "{n} sites",
        countTypes: "{n} types",
        countEvents: "{n} events",
    ...
    common: {
      ...
      aiModelUnavailableHint: "The key is valid but this model cannot be used. Reload the model list and pick another one from it.",
    ...
    bulk: {
      ...
      resyncSameEventTooltip: "Only update events of the same type as the selected rows",
      resyncAllEvents: "Re-query (all events)",
      resyncAllEventsTooltip: "Save every event ePort returns for the selected containers",
