...
export const translations = {
  vi: {
    ...
    dashboard: {
      ...
      kpis: {
        ...
        customsTitle: "Thông quan Hải quan",
        customsUncleared: "Chưa duyệt",
        customsCleared: "Đã duyệt",
      ...
      alerts: {
        ...
        unclearedConts: "Cont tồn bãi chưa duyệt HQ / Phí",
    ...
    booking: {
      ...
      dropzoneSubtitle: "Hỗ trợ trích xuất tự động PDF và Ảnh chụp booking từ các hãng tàu (Dongjin, PIL, ONE, SITC, Cosco, Maersk...)",
  ...
  en: {
    ...
    booking: {
      ...
      dropzoneSubtitle: "Supports automatic extraction for PDFs and booking photos from Dongjin, PIL, ONE, SITC, Cosco, Maersk and more",
